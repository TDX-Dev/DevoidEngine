...
namespace Elemental.Tools
{
    public static class EditorUI
    {
        ...
        public static bool PropertyVector3RGB(ref Vector3 value)
        {
            bool changed = false;
            ...
            // X
            ImGui.PushStyleColor(ImGuiCol.FrameBg, new Vector4(0.32f, 0.16f, 0.16f, 1.0f));
            ImGui.PushStyleColor(ImGuiCol.FrameBgHovered, new Vector4(0.40f, 0.20f, 0.20f, 1.0f));
            ImGui.PushStyleColor(ImGuiCol.FrameBgActive, new Vector4(0.48f, 0.24f, 0.24f, 1.0f));

            ImGui.SetNextItemWidth(width);
            float x = value.X;

            if (ImGui.DragFloat("##x", ref x, 0.1f))
            {
                value.X = x;
                changed = true;
            }
            ...
            // Y
            ImGui.PushStyleColor(ImGuiCol.FrameBg, new Vector4(0.16f, 0.32f, 0.16f, 1.0f));
            ImGui.PushStyleColor(ImGuiCol.FrameBgHovered, new Vector4(0.20f, 0.40f, 0.20f, 1.0f));
            ImGui.PushStyleColor(ImGuiCol.FrameBgActive, new Vector4(0.24f, 0.48f, 0.24f, 1.0f));

            ImGui.SetNextItemWidth(width);
            float y = value.Y;

            if (ImGui.DragFloat("##y", ref y, 0.1f))
            {
                value.Y = y;
                changed = true;
            }
            ...
            // Z
            ImGui.PushStyleColor(ImGuiCol.FrameBg, new Vector4(0.16f, 0.20f, 0.32f, 1.0f));
            ImGui.PushStyleColor(ImGuiCol.FrameBgHovered, new Vector4(0.20f, 0.25f, 0.40f, 1.0f));
            ImGui.PushStyleColor(ImGuiCol.FrameBgActive, new Vector4(0.24f, 0.30f, 0.48f, 1.0f));

            ImGui.SetNextItemWidth(width);
            float z = value.Z;

            if (ImGui.DragFloat("##z", ref z, 0.1f))
            {
                value.Z = z;
                changed = true;
            }
