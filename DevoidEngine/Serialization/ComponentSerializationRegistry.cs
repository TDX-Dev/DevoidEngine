...
namespace DevoidEngine.Serialization
{
    ...
    {
        private static readonly Dictionary<Type, Func<Component, byte[]>> engineSerializers = [];
        private static readonly Dictionary<string, Func<byte[], Component>> engineDeserializers = [];

        private static readonly Dictionary<string, Func<Component, byte[]>> scriptSerializers = [];
        private static readonly Dictionary<string, Func<byte[], Component>> scriptDeserializers = [];
