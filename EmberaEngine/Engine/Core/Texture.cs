...
namespace EmberaEngine.Engine.Core
{
    public class Texture
    {
        ...
        public static Texture GetWhite2D()
        {
            ...
            Tex.TexImage2D<byte>(1, 1, EmberaEngine.Engine.Core.PixelInternalFormat.Rgba16f, EmberaEngine.Engine.Core.PixelFormat.Rgba, EmberaEngine.Engine.Core.PixelType.UnsignedByte, null);
            Tex.GenerateMipmap();
