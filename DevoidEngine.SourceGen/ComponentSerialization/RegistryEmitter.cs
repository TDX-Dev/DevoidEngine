...
{
    internal class RegistryEmitter
    {
            ...
            ImmutableArray<INamedTypeSymbol> components)
        {
            ...
            sb.AppendLine("using DevoidEngine.Components;");
            ...
            foreach (var comp in components.Distinct(SymbolEqualityComparer.Default))
            {
                ...
                sb.AppendLine(
                    $"        DevoidEngine.Serialization.ComponentSerializationRegistry.Register(");
                sb.AppendLine(
                    $"            typeof({full}),");
                sb.AppendLine(
            ...
            //    sb.AppendLine(
            //        $"        DevoidEngine.Serialization.ComponentSerializationRegistry.Register<{full}>({name}Serializer.Serialize, {name}Serializer.Deserialize);");
            //}
